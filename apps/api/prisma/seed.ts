    ...
    children: [
      {
        ...
        children: crudButtons('system:user', [
          ...
          { name: 'system:user:export', title: '导出', type: 'BUTTON', perm: 'system:user:export' },
          { name: 'system:user:import', title: '导入', type: 'BUTTON', perm: 'system:user:import' },
        ]),
      },
      {
        name: 'Role',
      ...
      },
      {
        ...
        children: crudButtons('system:tenant'),
      },
      {
        name: 'Message',
        title: '消息中心',
        ...
        icon: 'MailOutlined',
        perm: 'system:message:list',
        children: crudButtons('system:message', [
          { name: 'system:message:send', title: '发送', type: 'BUTTON', perm: 'system:message:send' },
        ]),
      },
      {
        name: 'I18n',
        ...
        perm: 'system:i18n:list',
        children: crudButtons('system:i18n'),
      },
      {
        ...
        children: crudButtons('system:dashboard'),
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        type: 'MENU',
        path: '/workflow/def',
        component: 'workflow/def/index',
        icon: 'ApartmentOutlined',
        perm: 'workflow:def:list',
        children: crudButtons('workflow:def'),
      },
      {
        name: 'WorkflowTodo',
        title: '我的待办',
        type: 'MENU',
        path: '/workflow/todo',
        component: 'workflow/todo/index',
        icon: 'CarryOutOutlined',
        perm: 'workflow:task:mine',
      },
    ],
  },
  {
